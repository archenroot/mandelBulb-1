...
inline int UnProject(double winX, double winY, CameraParams camP, double *obj)
{
...
//----------------------------------------------------------------------------------------
inline void Perspective(double fov, double aspect, double zNear, double zFar, double *projMat)
{
  double ymax, xmax;
...
//----------------------------------------------------------------------
inline void LookAt(double *eye, double *target, double *upV, double *modelMatrix)
{
